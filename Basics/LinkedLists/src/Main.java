...
public class Main {
    ...
    public static void gettingElements(LinkedList<String> list) {
        ...
        System.out.println("Retrieving Element = " + list.get(4));
        System.out.println("Retrieving Element = " + list.get(7) + "\n");

        for (int i = 0; i < list.size(); i++) {
            System.out.println("Retrieving element " + (i + 1) + " = " + list.get(i));
        }
        ...
        System.out.println("_".repeat(30));
        System.out.println("Darwin is at position: " + list.indexOf("Dwarin"));
